...
def create_new(name, pretrained, channels, classes, autoshape, ckpt_path, device='cuda'):
    ...
    Arguments:
        ...
        autoshape (bool): wrap model class into autoShape wrapper or not
...
def create(name, pretrained, channels, classes, autoshape):
    ...
    try:
        ...
        if pretrained:
            ...
            torch.save(state_dict, '/content/yolov5l_.pt')
